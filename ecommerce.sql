...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 12 jan. 2024 à 19:21
...
--
-- Structure de la table `add_logo`
--
...
--
-- Déchargement des données de la table `add_logo`
--
...
--
-- Doublure de structure pour la vue `all_order_info`
...
--
-- Déchargement des données de la table `catagory`
--
...
(9, 'closes', 'closes new', 1);

-- --------------------------------------------------------

--
-- Structure de la table `cupon`
--
...
(1, 1, 'saiful', 4, 'This product is very good', '2024-01-11'),
(4, 5, 'karim', 6, 'Good product', '2024-01-15');

-- --------------------------------------------------------

--
-- Structure de la table `header_info`
--
...
--
-- Déchargement des données de la table `header_info`
--

INSERT INTO `header_info` (`id`, `email`, `tweeter`, `fb_link`, `pinterest`, `phone`) VALUES
(10, 'fruitsbazar@gmail.com', 'https://twitter.com/', 'https://facebook.com/', 'https://pinerest.com/', '0698236495');
...
--
-- Doublure de structure pour la vue `product_info_ctg`
-- (Voir ci-dessous la vue réelle)
--
...
(1, 'saiful', ' saiful', ' islam', 'saifulislamsapon@gmail.com', '202cb962ac59075b964b07152d234b70', 1246798, 'SubarnaChar, Noakhali', 5, '2023-12-21 13:38:23', '2023-12-21 13:38:23'),
(3, 'Omar6627', ' Omar Bin', ' Faruk', 'omarbfaruk@gmail.com', 'ad126b79a449eb003915c3917c8a30e1', 1684734323, 'Feni', 5, '2023-12-21 18:56:24', '2023-12-21 18:56:24'),
(5, 'karim', ' karim', ' ', 'karim@gmail.com', '202cb962ac59075b964b07152d234b70', 1840239402, 'Jatrabari, Dhaka', 5, '2023-12-14 05:03:25', '2023-12-14 05:03:25');
...
--
-- Structure de la vue `all_order_info`
--
...
--
-- Structure de la vue `product_info_ctg`
--
...
--
-- Index pour la table `cupon`
--
ALTER TABLE `cupon`
  ADD PRIMARY KEY (`cupon_id`);

--
-- Index pour la table `customer_feedback`
--
ALTER TABLE `customer_feedback`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `header_info`
--
...
--
-- AUTO_INCREMENT pour la table `add_logo`
--
ALTER TABLE `add_logo`
...
--
-- AUTO_INCREMENT pour la table `catagory`
--
ALTER TABLE `catagory`
  MODIFY `ctg_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT pour la table `cupon`
--
ALTER TABLE `cupon`
  MODIFY `cupon_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `customer_feedback`
--
ALTER TABLE `customer_feedback`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `header_info`
--
ALTER TABLE `header_info`
